...
print('Creating new repo named {0} in Github account {1}'.format(project, 'se42'))
# shell script for curl command to create Github repository
os.system('../myutils/gitcreate.sh {0} {1}'.format(project, 'se42'))
os.system('git remote add origin https://github.com/se42/{0}.git'.format(project))
